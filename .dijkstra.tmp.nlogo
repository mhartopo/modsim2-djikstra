...
;; An implementation of the Dijkstra algorithm in NetLogo
;; (single-pair shortest path)
...
to setup-graph
  setup-vertices
  setup-edges-with-n-vertices-per-edge num-edge
...
to setup-vertices
  create-ordered-vertices num-node [
...
@#$#@#$#@
## What is it?
An implementation of Dijkstra's graph search algorithm (single-pair shortest path).
@#$#@#$#@
default
true
0
